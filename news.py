starter_news = [
    ...
    "Seus cookies são comentados a quilômetros de distância.", 
    "Seus biscoitos são famosos em toda a cidade!", 
...
intermediate_news = [
    ...
    "Reis e rainhas de todo o mundo estão desfrutando de seus biscoitos.",
    "Agora existem museus dedicados aos seus cookies.",
    "Um dia nacional foi criado em homenagem aos seus cookies.",
...
pro_news = [
    ...
    "Seres de outras dimensões surgem apenas para provar seus biscoitos.",
    "Seus cookies alcançaram senciência.",
    "O universo agora se transformou em massa de biscoito, ao nível molecular.",
    "Seus cookies estão reescrevendo as leis fundamentais do universo.",
    "Uma estação de notícias local veicula um segmento de 10 minutos sobre seus cookies. Sucesso!",
...
legendary_news = [
    ...
    "Biscoitos de fazenda ao ar livre populares entre os jovens modernos de hoje, diz especialista.",
    "Biscoitos agrícolas considerados impróprios para veganos, diz nutricionista.",
    "[entre 2 e 1001, inclusive] mineiros mortos na catástrofe da mina de chocolate!",
    "[entre 2 e 1001, inclusive] mineiros presos na mina de chocolate desmoronada!",
...
mythical_news = [
    ...
    "Cookies de fábrica ligados à obesidade, diz estudo.",
    "Empréstimos de cookies em ascensão, pois as pessoas não podem mais comprá-los com dinheiro normal.",
